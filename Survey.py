...
class survey(Frame):
    ...
    def createsurvey(self):
        ...
        Checkbutton(self,text="Male",variable=self.checkm,command=self.male).grid(row=15,column=0,sticky=W)
        Checkbutton(self,text="Female",variable=self.checkf,command=self.female).grid(row=16,column=0,sticky=W)
        self.q5=Label(self,text="Your Religion").grid(row=17,column=0,sticky=W)
