...
class survey(Frame):
    ...
    def createsurvey(self):
       ...
       # self.checkm=BooleanVar()
        ...
        self.lbl3=Label(self,text="Overview").grid(row=19,column=0,sticky=W)
        self.ent=Text(self,width=40,height=2,wrap=WORD).grid(row=20,column=0,columnspan=3)
        self.bttn=Button(self,text="Submit",command=self.compose).grid(row=21,column=0,sticky=W)

    def compose(self):
        gotten1=self.a1.get()
        self.ent.insert(0.0,gotten1)
